#aptextra.sh
~/.bin/aptextra)
 export USAGE='USAGE: aptextra ${ libdvd-pkg | mega | qemu | unattended | visualstudio | protonvpn }'
 case "$1" in
  libdvd-pkg)
   aptu
   for APTLIBDVDPKG in\
  ...
  mega)
   aptu
   for APTMEGA in 'megasync_5.4.1-1.1_amd64.deb' 'megacmd_1.7.0-6.1_amd64.deb';do
