...
#update grub and initial ram disk
ugir(){
...
#Build sol
bldsol(){
 export USAGE='USAGE: bldsol ${ i(nstaller) | n(ano) | d(efault) <--YOU PROBABLY WANT THIS ONE | f(ull) | me } ${ bleach || clean }'
 case "$1" in
  i|installer)
   #Test privileges
   testpriv
